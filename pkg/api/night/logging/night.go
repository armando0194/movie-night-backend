...
func New(svc night.Service, logger model.Logger) *LogService {
	return &LogService{
		Service: svc,
		logger:  logger,
	}
...
// Create logging
func (ls *LogService) Create(c *gin.Context, req model.MovieNight) (resp *model.MovieNight, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
			name, "Create night request", err,
			[]zap.Field{
